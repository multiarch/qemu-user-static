...
from_arch="x86_64"
to_archs="aarch64 aarch64_be alpha armeb arm cris hppa i386 m68k microblaze mips64el mips64 mipsel mipsn32el mipsn32 mips nios2 or1k ppc64le ppc64 ppc riscv32 riscv64 s390x sh4eb sh4 sparc32plus sparc64 sparc trace-stap x86_64 xtensaeb xtensa "
# For casual test
# to_archs="aarch64"
